...
export default function Main() {
  return(
    <div className="flex md:flex-row md:justify-evenly flex-col space-y-3">
      <div className="flex justify-center">
        <Image alt="" src={Cup} width={450} height={460} className="rounded-lg"/>
      </div>
      <div className="flex flex-col sm:space-y-10 space-y-5 px-2 md:w-96 text-xs justify-center">
        <p>
